...
do {
    ...
    foreach ($data['data']['orders']['edges'] as $edge) {
        ...
        if ($selectedPaymentStatus && strtolower($o['displayFinancialStatus']) !== strtolower($selectedPaymentStatus)) continue;
        if ($selectedFulfillmentStatus && strtolower($o['displayFulfillmentStatus']) !== strtolower($selectedFulfillmentStatus)) continue;
